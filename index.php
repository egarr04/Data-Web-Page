...
?>
        ...
        <div class="content">
            ...
            echo "<h2><a href='tampilandatajkt.php?id=" . $row['konektor'] . "'>  " . $row['Txt_menu'] . "</a></h2>";
            echo "</div>";
            }
            echo "</div>";
...
while ($row = $result->fetch_assoc()) {
    echo "<div style='border: 1px solid #ccc; padding: 10px; display: flex; align-items: center;'>";
        echo "<img src='data:image/jpeg;base64," . base64_encode($row['Gambar']) . "' alt='Gambar Artikel' style='width: 200px; height: 200px; margin-right:10px;'>";
        echo "<div>";
